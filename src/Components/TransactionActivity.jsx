  ...
  return (
    <>
        ...
        <div className="bg-white h-[250px] mt-8 rounded-3xl shadow">
            ...
            <div>
            <p className='px-8 pt-8 pb-1 text-black  text-3xl'>Carbon Limits</p>
            <p className='px-8 text-black  pb-7'>Renewable Energy, Ukraine</p>
            </div>
            ...
            <div className="flex h-auto px-4">
                ...
                <p className='px-6 py-4 text-lg ml-[190px] text-black '><b>7189 / </b>10000</p>
                <p className='px-6 py-4 text-lg ml-[110px] text-black '>Offset Available </p>
                <p className='px-6 py-4 text-lg ml-[160px] text-black '><b>7189 / </b>10000</p>
